...
fprintf(fid,'\nRESPONSE VARIABLES:\n');
fprintf(fid,'If the category-keyboard mapping = 1 (i.e., using right hand), n=catA, j=catB\n');
fprintf(fid,'If the category-keyboard mapping = 2 (i.e., using left hand), v=catA, f=catB\n');
