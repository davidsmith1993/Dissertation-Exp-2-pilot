...
%         data.categoryStructure = 1; %Rule Based = 1
%         data.categoryStructureText = 'RB'; 
%         load RB.stim; 
%         trainingStim = RB;
        data.numTrainingTrials = size(trainingStim,1);
        
%         data.transferCondition = input('Transfer Condition: (A/B classification = 1; inference = 2)  ');
%         switch data.transferCondition
%             case 1,
%                 data.transferConditionText = 'AB'; 
%             case 2,
%                 data.transferConditionText = 'INF'; 
%             otherwise,
%                 escape('Q','when entering transfer condition text'); 
%         end
